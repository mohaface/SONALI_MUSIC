...
TAGMES = [ " **❅ عزیزم کجایی؟ ** ",
           " **❅ اوه تو خوابی بیا آنلاین.😊** ",
           " **❅ Oye VC بیایید صحبت کنیم. ** ",
           " **❅ غذا خوردی یا نه؟ ** ",
           " **❅ همه در خانه چطور هستند؟ ** ",
           " **❅ میدونم خیلی دلم برات تنگ شده. ** ",
           " **❅ و بگو چطوری...؟؟ ** ",
           " **❅ لطفا تنظیمات من را انجام دهید..?? ** ",
           " **❅ اسمت چیه…؟؟ ** ",
           " **❅ صبحانه تموم شد..؟؟ ** ",
           " **❅ من را به گروه خود اضافه کنید. ** ",
           " **❅ دوست شما با شما تماس می گیرد. ** ",
           " **❅ با من ازدواج میکنی..؟؟ ** ",
           " **❅ رفتی بخوابی🙄** ",
           " **❅ سلام دوست، AC را روشن کن😕** ",
           " **❅ اهل کجایی...؟؟ ** ",
           " **❅ سلام جی نامسته 😛** ",
           " **❅ عزیزم داری چیکار میکنی..؟ ** ",
           " **❅ منو میشناسی؟ ** ",
           " **❅ بیا عزیزم بیا لودو بازی کنیم.🤗** ",
           " **❅ از 9 تا 12 اجرا میشه...😇** ",
           " **❅ پدرت چیکار میکنه🤭** ",
           " **❅ بیا عزیزم بیا بریم بازار گلگپا بخوریم. ** ",
           " **❅ تنها به بازار نروید، مورد توجه قرار می گیرید. ** ",
           " **❅ و به من بگویید BF شما چطور است..؟؟ ** ",
           " **❅ صبح بخیر 😜** ",
           " **❅ آیا یک کار برای من انجام می دهید؟ ** ",
           " **❅ دی جی ولی بابو، آهنگ من را پخش کن. ** ",
           " **❅ از آشنایی با شما خوشحالم.☺** ",
           " **❅ کلانتری بابوی من...؟ ** ",
           " **❅ تحصیلاتت چطور پیش میره؟ ** ",
           " **❅ عاشق شدیم. ** ",
           " **❅ نیکا کیست...؟ ** ",
           " **❅ تو عکس من را می گیری..؟ ** ",
           " **❅ گوشی رو قطع کن مامان اومده؟ ** ",
           " **❅ و کی قراره با خواهرشوهرش آشنا بشی؟ ** ",
           " **❅ دوستم داری 💚** ",
           " **❅ خیلی دوستت دارم..؟ ** ",
           " **❅ عزیزم منو ببوس..؟؟ ** ",
           " **❅ جوک بگم..؟ ** ",
           " **❅ بیا vc بذار یه چیزی بهت نشون بدم😻** ",
           " **❅ اینستاگرام رو فالو میکنی..؟؟ ** ",
           " **❅ شماره واتساپ خود را به من بدهید..؟ ** ",
           " **❅ لطفا تنظیمات من را توسط دوستتان انجام دهید..؟ ** ",
           " **❅ اگر همه کارها انجام شد، آنلاین شوید...؟ ** ",
           " **❅ اهل کجایی 😊** ",
           " **❅ برو من تو را از دل آزاد کردم. ** ",
           " **❅ آیا یک کار برای من انجام می دهید، چند عضو به گروه اضافه کنید..؟ ** ",
           ...
           " **❅ منو فراموش کردی 😏**** ",
           " **❅ چرا به من دروغ گفتی 🤐** ",
           " **❅ اینقدر عاطفه نخورید نون بخور لااقل چاق میشی😒** ",
           " **❅ این نگرش رو به کی نشون میدی 😮** ",
           " **❅ هملو گفت سرت شلوغه 👀** ",
           " **❅ خیلی خوشحالم که دوستی مثل شما دارم. ** ",
           " **❅ امروز خیلی ناراحتم ☹️** ",
           " **❅ با من هم صحبت کن 🥺** ",
           " **❅ امروز شام چیه👀** ",
           " **❅ چه خبر است 🙂** ",
           " **❅ چرا پیام نمیدی..🥺** ",
           " **❅ من بی گناهم 🥺** ",
           " **❅ دیروز خوش گذشت😅** ",
           " **❅ گفت دیروز سرت شلوغ بود😕** ",
           " **❅ آیا در رابطه هستید..؟ ** ",
           " **❅ تو خیلی آروم هستی دوست😼** ",
           " **❅ آیا آواز خواندن بلدید، آواز بخوانید..؟ ** ",
           " **❅ با من میری بیرون..؟؟ ** ",
           " **❅ همیشه شاد باشی دوست 🤞** ",
           " **❅ میشه دوست باشیم...؟ ** ",
           " **❅ متاهل هستی..🥺** ",
           " **❅ این روزها کجا مشغول هستید🥲** ",
           " **❅ مجرد یا مجرد 😉** ",
           " **❅ بیا جشن بگیریم 🥳** ",
           " **❅ به @knmusic_moha بپیوندید 🧐** ",
           " **❅ دوستت ندارم، 🥺** ",
           " **❅ بیا اینجا @ATRIN_MUSIC_TM بیا لذت ببریم 🤭** ",
           " **❅ فراموشم کن،..؟ ** ",
           " **❅ مال خودت کن پیا، مال خودت کن 🥺** ",
           " **❅ به گروه من هم بپیوندید 🤗** ",
           " **❅ اسمت را در دلم نگه داشتم😗** ",
           " **❅همه دوستانت کجا هستند🥺** ",
           " **❅ صاحب ناز من @rainbow_dragonn 🥰** ",
           " **❅ عشق من به یاد کی گم شدی😜** ",
           " **❅ شب بخیر جی، شب طولانی بود.** ",
           ]
